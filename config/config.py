...
RSI_OVERSOLD = 50  # RSI value below which the asset is considered oversold (buy signal)

# MACD (Moving Average Convergence Divergence) Configuration
MACD_SHORT = 6  # Short-term EMA (Exponential Moving Average) period for MACD
MACD_LONG = 15  # Long-term EMA period for MACD
MACD_SIGNAL = 4  # Signal line EMA period used to generate buy/sell crossovers
